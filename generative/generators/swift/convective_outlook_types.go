...
const spcOutlookSwiftTopComment = `// This file was generated by generative/generators/swift/convective_outlook_types.go.
...
const spcOutlookEnumConversion = `func ConvectiveOutlookTypesOptions() -> Array<Option> {
